# C Programming – Intermediate Practice

A curated collection of intermediate-level C programming exercises designed to strengthen problem-solving abilities, logical thinking, and understanding of core programming concepts.

This repository builds upon basic C programming knowledge and introduces slightly more complex logic using loops, arrays, and string manipulation.

The goal of this project is to practice structured programming while developing clean and readable C code.
